"""emphasis_17936 URL Configuration
...
admin.site.site_header = "Emphasis"
admin.site.site_title = "Emphasis Admin Portal"
admin.site.index_title = "Emphasis Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Emphasis API",
        default_version="v1",
        description="API documentation for Emphasis App",
    ),
    public=True,
